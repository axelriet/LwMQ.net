...
These APIs allow applications to create messages, append data frames to messages, and send messages through communication channels.

The messaging APIs are designed for high performance with high throughput and low latency, making them suitable for a wide range of applications that require efficient message-based communication.
